...
<img src="/diagrams/data/replication-1.svg" alt="Single-leader replication: one writer, many readers" style="max-width:100%;height:auto;margin:1.5rem auto;display:block;"/>
...
<img src="/diagrams/data/replication-2.svg" alt="Synchronous vs asynchronous replication trade-off" style="max-width:100%;height:auto;margin:1.5rem auto;display:block;"/>
...
<img src="/diagrams/data/replication-3.svg" alt="Leaderless quorum: N=3, W=2, R=2 writes and reads" style="max-width:100%;height:auto;margin:1.5rem auto;display:block;"/>
