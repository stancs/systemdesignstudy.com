...
<img src="/diagrams/patterns/event-driven-1.svg" alt="One event fans out to many independent subscribers" style="max-width:100%;height:auto;margin:1.5rem auto;display:block;"/>
...
<img src="/diagrams/patterns/event-driven-2.svg" alt="Orchestrated saga: coordinator drives each step with compensation on failure" style="max-width:100%;height:auto;margin:1.5rem auto;display:block;"/>
